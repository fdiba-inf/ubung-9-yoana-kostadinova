...
public Rectangle(Point startPoint, double a, double b) {
...
public boolean equal(Ellipse otherEllipse) {
        boolean sameA = Utils.equals(a, otherRectangle.a);
        boolean sameB = Utils.equals(b, otherRectangle.b);
        boolean sameAReversed = Utils.equals(a, otherRectangle.b);
        boolean sameBReversed = Utils.equals(b, otherRectangle.a);
